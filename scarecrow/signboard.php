...
<!--[if gt IE 8]><!--><html class="no-js"><!--<![endif]-->
    <head>
        ...
        <title>Sign Board Design | Scarecrow Production</title>
        ...
        <div class="twelve column">
            <div class="row">
                <div class="eight column se">
                    <div class="web-left">
                        <img src="images/print-design/print1.jpg">
                    </div>
                </div>
                <div class="four column se">
                    <div class="web-right">
                    <h2>iTumba - <span>Your way to stay in touch</span></h2>
                    <p>Do you require rich and realastic and natural Photographs? Reach out to Scarecrow Production! Photographs are memories. We have Expertsd who can make your occasion a special and Memorable one.</p>
                     <h3>iTumba.com</h3>
                       <ul>
                       <li><a href="logos.php">Logo Design</a></li>
                       <li><a href="websites.php">Web Design</a></li>
                       <li><a href="illustrator.php">UI Design</a></li>
                       <li><a href="">Online Marketing</a></li>
                       <li><a href="print.php">Print Design Multimedia</a></li>
                       </ul>
                    </div>
                </div>
            </div>
