var ddsmoothmenu={arrowimages:{down:['downarrowclass','http://www.niyati.sg/images/blank.gif','1','1'],right:['rightarrowclass','http://www.niyati.sg/images/blank.gif']},transition:{overtime:300,outtime:300},shadow:{enabled:true,offsetx:0,offsety:0},detectwebkit:navigator.userAgent.toLowerCase().indexOf("applewebkit")!=-1,detectie6:document.all&&!window.XMLHttpRequest,getajaxmenu:function($,setting){var $menucontainer=$('#'+setting.contentsource[0])
...
ddsmoothmenu.init({mainmenuid:"smoothmenu2",orientation:'h',classname:'ddsmoothmenu',contentsource:"markup"})